...
%% BRIGGS stability classes
    classA = struct('u',10,'sigma_y',0.22.*x_rx./(sqrt(1+0.0001.*x_rx)), 'sigma_z',0.2.*x_rx);
    classB = struct('u',10,'sigma_y',0.16.*x_rx./(sqrt(1+0.0001.*x_rx)), 'sigma_z',0.12.*x_rx);
    classC = struct('u',10,'sigma_y',0.11.*x_rx./(sqrt(1+0.0001.*x_rx)), ...
        'sigma_z',0.08.*x_rx./(sqrt(1+0.0002.*x_rx)));
    classD = struct('u',10,'sigma_y',0.08.*x_rx./(sqrt(1+0.0001.*x_rx)), ...
...
figure
 plot(x_rx, C_air_A_far_field, 'LineWidth', 1.5); hold on
...
figure
 plot(x_rx, C_air_A./C_air_A_far_field, 'LineWidth', 1.5); hold on
 plot(x_rx, C_air_B./C_air_B_far_field, 'LineWidth', 1.5)
 plot(x_rx, C_air_C./C_air_C_far_field, 'LineWidth', 1.5)
 plot(x_rx, C_air_D./C_air_D_far_field, 'LineWidth', 1.5)
% plot(x_rx, C_air_E, 'LineWidth', 1.5)
%plot(x_rx, C_air_F, 'LineWidth', 1.5)
hold off
