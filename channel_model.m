...
x_rx = 0:0.01:2;    %rx x-position [m]
y_rx = 0;           %rx y-position [m]
y_tx = 1;           %rx z-position [m]
...
% Channel
u_x = 1;             %wind speed x-direction [m/s]
...
%% VOCs concentration
k = (1/u_x)*D ;           %integral of Eddy diffusivities (D = constant)
A = (m_tau_e/8)*(1/(pi*k)^(3/2)); %
C = 0;
